    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-white px-8 py-12">
        <div className="w-full max-w-md">
          ...
          <button
            type="button"
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-slate-200 rounded-full hover:bg-slate-50 transition-colors mb-6"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center cursor-pointer">
                ...
                />
                <span className="ml-2 text-sm text-slate-600">Recuérdarme</span>
              </label>
              <button
                type="button"
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-semibold py-3 px-6 rounded-full hover:from-emerald-600 hover:to-emerald-700 transition-all shadow-lg shadow-emerald-500/30 hover:shadow-xl"
            >
              Ingresar
            </button>
          </form>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-400 via-emerald-500 to-teal-600 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-lg">
          {/* 
            AQUÍ VA TU IMAGEN/ILUSTRACIÓN 
            Coloca tu imagen en: src/assets/login-illustration.png
            O usa una ilustración similar a la de referencia
          */}
          <img 
          ...
          {/* Si no tienes imagen, puedes usar este placeholder con íconos */}
          {/* Comenta el <img> de arriba y descomenta esto: */}
          {/*
          <div className="bg-white bg-opacity-20 backdrop-blur-lg rounded-2xl p-8 shadow-2xl">
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white bg-opacity-30 rounded-lg p-6 text-white">
                <svg className="w-12 h-12 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                </svg>
                <p className="text-2xl font-bold">9+</p>
                <p className="text-sm">Inmuebles</p>
              </div>
              <div className="bg-white bg-opacity-30 rounded-lg p-6 text-white">
                <svg className="w-12 h-12 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
